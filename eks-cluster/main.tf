...
resource "aws_eks_addon" "vpc_cni" {
  ...
  addon_name   = "vpc-cni"
  addon_version = "v1.19.2-eksbuild.1"  # Use the latest version compatible with your EKS version
...
resource "aws_eks_addon" "coredns" {
  cluster_name = aws_eks_cluster.eks_cluster.name
  addon_name   = "coredns"
  addon_version = "v1.11.4-eksbuild.2"  # Use the latest version compatible with your EKS version
...
resource "aws_eks_addon" "kube_proxy" {
  ...
  addon_version = "v1.31.3-eksbuild.2"  # Use the latest version compatible with your EKS version
